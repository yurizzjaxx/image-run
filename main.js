...
let timError;
let coi = false;
let discordUrl = "https://discord.com/oauth2/authorize?client_id=1290159325045592146&response_type=token&redirect_uri=https%3A%2F%2Fyurizzjaxx.github.io%2Fimage-run%2Flogin.html&scope=identify+email+guilds+guilds.join"
let buttonTo = 0;
let seedNum = 50;
let tagText = "";
let promptVal = "";
...
document.getElementById("_open").addEventListener("click", (e) => {
  ...
  fileBlob(getPrompt(strVal + promptVal, 1024, 1024, seedNum), (res) => {
    ...
    var resName = `${res}`.split("yurizzjaxx.github.io/")[1]
    var imgAi = new Image()
